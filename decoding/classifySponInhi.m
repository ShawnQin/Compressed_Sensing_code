...
% We use the optimized sensitivity matrix derived from different r0
...
% L = length(allfmin);  % this the number of repeat for one parameter
nOdor = 50;
nRecep = 10;
spar = 2;
sig = 2;
