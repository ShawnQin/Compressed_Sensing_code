% this script calculate how the representation free energy change with the
...
spAll = 0.05:0.05:1;
summF = zeros(length(spAll),2); %mean and std of free energy
for i0 = 1:length(spAll)
        ...
        lbd = 0.1;   % the weight of metabolic cost
